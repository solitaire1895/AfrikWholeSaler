...
function QuotePageContent() {
  ...
  const preselected = preselectedProduct
  ...
  const [formData, setFormData] = useState({
    ...
    quantity: preselected?.moq?.toString() || "100",
    targetPrice: "",
          ...
          <Card className="p-6 sm:p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {preselected ? (
                  <div className="flex items-center justify-between p-3 rounded-[var(--radius-input)] border border-brand bg-brand-light">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, productName: "", productSlug: "" })
                      }
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  type="submit"
                  className="flex-1 flex h-12 items-center justify-center gap-2 rounded-[var(--radius-button)] bg-brand text-white text-sm font-semibold hover:bg-brand-hover shadow-[var(--shadow-button)] transition-all"
                >
